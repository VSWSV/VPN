...
echo -e "      ${green}1.${reset} 设置系统语言为中文"
echo -e "      ${green}2.${reset} 永久禁用APT锁冲突问题"
echo -e "      ${green}3.${reset} 安装必要工具 GIT和CUR"
...
echo -e "${green}🈶 正在安装中文语言支持包...${reset}"
sudo apt install -y language-pack-zh-hans
echo -e "${green}✅ 中文语言包安装完成${reset}"

echo -e "${green}🌏 正在设置系统默认语言为中文...${reset}"
sudo update-locale LANG=zh_CN.UTF-8 LANGUAGE=zh_CN:zh
echo -e "${green}✅ 系统语言已设置为中文${reset}"
...
echo -e "              ${green}🎉 建议使用命令 ${yellow}reboot${green} 重启系统！${reset}"
echo -e "${blue}╚═════════════════════════════════════════════════════════════════════════════════╝${reset}"
