...
while true; do
  ...
  read -p "请输入选项编号： " opt
  case $opt in
    1) bash /root/VPN/menu/install/full_install.sh; break ;;
    2) bash /root/VPN/menu/install/upgrade_components.sh; break ;;
    3) bash /root/VPN/menu/install/check_dependencies.sh; break ;;
    4) bash /root/VPN/menu/install/verify_installation.sh; break ;;
