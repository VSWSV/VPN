...
while true; do
  ...
  echo -e "${pink}╠═════════════════════════════════════════════════════════════════════════════════╣${reset}"
  echo -e "  ${yellow}❶${reset} ${green}查看本机 IP 地址${reset}               ${yellow}❷${reset} ${green}网络连通性测试${reset}"
  echo -e "  ${yellow}❸${reset} ${green}Ping 指定 IP${reset}               ${yellow}❹${reset} ${green}查看端口使用情况${reset}"
  echo -e "  ${yellow}❺${reset} ${green}查看日志${reset}                     ${yellow}⓿${reset} ${red}返回主菜单${reset}"
  echo -e "${pink}╚═════════════════════════════════════════════════════════════════════════════════╝${reset}"
